...
class binarytree
	...
	public void inorder(node temp,int sum)
	{
		if(temp==null)
		{
...

	{
		...
		public static void main(String args[])
		{
			...
			while(true)
			{
          		  ...
          		  System.out.println("Press 3 for printing the tree sum from root to leaf \n\n");
          		  int a=scan.nextInt();
          		  switch(a)
          		  {
          		  case 1:
          		  ...
          		  case 2:
          		  		...
          		  		System.out.println("RECURSIVE TRAVERSAL:");
			  				System.out.print("\nDFT:\nINORDER TRAVERSAL:\t");
			  				btree.inorder(btree.root,0);System.out.println();
